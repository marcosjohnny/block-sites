...
:: curl -o sites.txt https://raw.githubusercontent.com/marcosjohnny/bloquear-sites-windows/main/sites.txt
powershell -Command "Invoke-WebRequest -Uri https://raw.githubusercontent.com/marcosjohnny/bloquear-sites-windows/main/sites.txt -OutFile sites.txt"
